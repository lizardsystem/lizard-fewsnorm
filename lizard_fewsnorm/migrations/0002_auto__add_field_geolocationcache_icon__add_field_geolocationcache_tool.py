...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeoLocationCache.icon'
        db.add_column('lizard_fewsnorm_geolocationcache', 'icon', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)

        # Adding field 'GeoLocationCache.tooltip'
        db.add_column('lizard_fewsnorm_geolocationcache', 'tooltip', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'GeoLocationCache.icon'
        db.delete_column('lizard_fewsnorm_geolocationcache', 'icon')

        # Deleting field 'GeoLocationCache.tooltip'
        db.delete_column('lizard_fewsnorm_geolocationcache', 'tooltip')
