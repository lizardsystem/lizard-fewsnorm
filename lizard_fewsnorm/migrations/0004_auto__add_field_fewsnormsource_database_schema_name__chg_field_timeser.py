...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FewsNormSource.database_schema_name'
        db.add_column('lizard_fewsnorm_fewsnormsource', 'database_schema_name', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)

        # Manually removed fewsnorm models.
        # Changing field 'TimeseriesManualEditsHistory.serieskey'
        # db.alter_column(u'nskv00_opdb"."timeseriesmanualeditshistory', 'serieskey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.Series'], primary_key=True, db_column='serieskey'))

        # Changing field 'TimeseriesComments.serieskey'
        # db.alter_column(u'nskv00_opdb"."timeseriescomments', 'serieskey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.Series'], null=True, primary_key=True, db_column='serieskey'))

        # Deleting field 'Timesteps.description'
        # db.delete_column(u'timesteps', 'description')


    def backwards(self, orm):

        # Deleting field 'FewsNormSource.database_schema_name'
        db.delete_column('lizard_fewsnorm_fewsnormsource', 'database_schema_name')

        # Changing field 'TimeseriesManualEditsHistory.serieskey'
        # db.alter_column(u'nskv00_opdb"."timeseriesmanualeditshistory', 'serieskey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.TimeseriesKeys'], primary_key=True, db_column='serieskey'))

        # Changing field 'TimeseriesComments.serieskey'
        # db.alter_column(u'nskv00_opdb"."timeseriescomments', 'serieskey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.TimeseriesKeys'], null=True, primary_key=True, db_column='serieskey'))

        # Adding field 'Timesteps.description'
        # db.add_column(u'timesteps', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)
    ...
    models = {
        ...
        'lizard_fewsnorm.aggregationperiods': {
            'Meta': {'object_name': 'AggregationPeriods', 'db_table': 'u\'nskv00_opdb"."aggregationperiods\'', 'managed': 'False'},
        ...
        'lizard_fewsnorm.event': {
            'Meta': {'object_name': 'Event', 'db_table': 'u\'nskv00_opdb"."timeseriesvaluesandflags\'', 'managed': 'False'},
        ...
        'lizard_fewsnorm.location': {
            'Meta': {'object_name': 'Location', 'db_table': 'u\'nskv00_opdb"."locations\'', 'managed': 'False'},
        ...
        'lizard_fewsnorm.moduleinstances': {
            'Meta': {'object_name': 'ModuleInstances', 'db_table': 'u\'nskv00_opdb"."moduleinstances\'', 'managed': 'False'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
        ...
        'lizard_fewsnorm.parameter': {
            'Meta': {'object_name': 'Parameter', 'db_table': 'u\'nskv00_opdb"."parameters\'', 'managed': 'False'},
            'attributea': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'attributeb': ('django.db.models.fields.FloatField', [], {}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
        ...
        'lizard_fewsnorm.parametergroups': {
            'Meta': {'object_name': 'ParameterGroups', 'db_table': 'u\'nskv00_opdb"."parametergroups\'', 'managed': 'False'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
        ...
        'lizard_fewsnorm.qualifiers': {
            'Meta': {'object_name': 'Qualifiers', 'db_table': 'u\'nskv00_opdb"."qualifiers\'', 'managed': 'False'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
            'qualifierkey': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True', 'db_column': "'qualifierkey'"})
        },
        'lizard_fewsnorm.qualifiersets': {
            'Meta': {'object_name': 'QualifierSets', 'db_table': 'u\'nskv00_opdb"."qualifiersets\'', 'managed': 'False'},
            'id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
        ...
        'lizard_fewsnorm.series': {
            'Meta': {'object_name': 'Series', 'db_table': 'u\'nskv00_opdb"."timeserieskeys\'', 'managed': 'False'},
        ...
        'lizard_fewsnorm.timeseriescomments': {
            'Meta': {'object_name': 'TimeseriesComments', 'db_table': 'u\'nskv00_opdb"."timeseriescomments\'', 'managed': 'False'},
        ...
        'lizard_fewsnorm.timeseriesmanualeditshistory': {
            'Meta': {'object_name': 'TimeseriesManualEditsHistory', 'db_table': 'u\'nskv00_opdb"."timeseriesmanualeditshistory\'', 'managed': 'False'},
            'comments': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
        ...
        'lizard_fewsnorm.timesteps': {
            'Meta': {'object_name': 'Timesteps', 'db_table': 'u\'nskv00_opdb"."timesteps\'', 'managed': 'False'},
            'id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
            'timestepkey': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True', 'db_column': "'timestepkey'"})
        },
        'lizard_fewsnorm.users': {
            'Meta': {'object_name': 'Users', 'db_table': 'u\'nskv00_opdb"."users\'', 'managed': 'False'},
            'id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
