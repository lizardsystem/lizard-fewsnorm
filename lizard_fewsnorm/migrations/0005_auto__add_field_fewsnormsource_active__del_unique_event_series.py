...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # db.delete_unique(u'nskv00_opdb"."timeseriesvaluesandflags', ['serieskey'])

        # Adding field 'FewsNormSource.active'
        db.add_column('lizard_fewsnorm_fewsnormsource', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'FewsNormSource.active'
        db.delete_column('lizard_fewsnorm_fewsnormsource', 'active')

        # Adding unique constraint on 'Event', fields ['series']
        # db.create_unique(u'nskv00_opdb"."timeseriesvaluesandflags', ['serieskey'])
