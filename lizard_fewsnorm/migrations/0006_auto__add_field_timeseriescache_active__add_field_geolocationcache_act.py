...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Manually removed constraints
        # Removing unique constraint on 'Event', fields ['series']
        #db.delete_unique(u'kvwn00_opdb"."timeseriesvaluesandflags', ['serieskey'])

        # Adding field 'TimeSeriesCache.active'
        db.add_column('lizard_fewsnorm_timeseriescache', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'GeoLocationCache.active'
        db.add_column('lizard_fewsnorm_geolocationcache', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'TimeSeriesCache.active'
        db.delete_column('lizard_fewsnorm_timeseriescache', 'active')

        # Deleting field 'GeoLocationCache.active'
        db.delete_column('lizard_fewsnorm_geolocationcache', 'active')
