...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Manually removed constraint
        # Removing unique constraint on 'Event', fields ['series']
        #db.delete_unique(u'kvwn00_opdb"."timeseriesvaluesandflags', ['serieskey'])

        # Adding field 'GeoLocationCache.data_set'
        db.add_column('lizard_fewsnorm_geolocationcache', 'data_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataSet'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'GeoLocationCache.data_set'
        db.delete_column('lizard_fewsnorm_geolocationcache', 'data_set_id')
