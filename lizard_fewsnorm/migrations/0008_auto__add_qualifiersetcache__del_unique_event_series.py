...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'QualifierSetCache'
        db.create_table('lizard_fewsnorm_qualifiersetcache', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ident', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('lizard_fewsnorm', ['QualifierSetCache'])


    def backwards(self, orm):

        # Deleting model 'QualifierSetCache'
        db.delete_table('lizard_fewsnorm_qualifiersetcache')
