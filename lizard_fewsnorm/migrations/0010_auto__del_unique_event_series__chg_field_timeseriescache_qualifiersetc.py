...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeSeriesCache.qualifiersetcache'
        db.alter_column('lizard_fewsnorm_timeseriescache', 'qualifiersetcache_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.QualifierSetCache'], null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TimeSeriesCache.qualifiersetcache'
        raise RuntimeError("Cannot reverse this migration. 'TimeSeriesCache.qualifiersetcache' and its values cannot be restored.")
