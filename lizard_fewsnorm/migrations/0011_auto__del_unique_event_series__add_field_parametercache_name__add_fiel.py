...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParameterCache.name'
        db.add_column('lizard_fewsnorm_parametercache', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'ParameterCache.shortname'
        db.add_column('lizard_fewsnorm_parametercache', 'shortname', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParameterCache.name'
        db.delete_column('lizard_fewsnorm_parametercache', 'name')

        # Deleting field 'ParameterCache.shortname'
        db.delete_column('lizard_fewsnorm_parametercache', 'shortname')
