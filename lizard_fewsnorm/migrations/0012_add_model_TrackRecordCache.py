...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TrackRecordCache'
        db.create_table('lizard_fewsnorm_trackrecordcache', (
        ...
        db.send_create_signal('lizard_fewsnorm', ['TrackRecordCache'])


    def backwards(self, orm):
        
        # Deleting model 'TrackRecordCache'
        db.delete_table('lizard_fewsnorm_trackrecordcache')
